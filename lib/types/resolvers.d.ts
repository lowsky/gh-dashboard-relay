...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
    UserOrCommitAuthor:
        | GithubCommitAuthor
        | (Omit<GithubUser, 'repos'> & { repos?: Maybe<Array<Maybe<_RefType['GithubRepo']>>> });
};

/** Mapping between all available schema types and the resolvers types */
export type ResolversTypes = {
    Boolean: ResolverTypeWrapper<Scalars['Boolean']['output']>;
    GithubAPI: ResolverTypeWrapper<
        Omit<GithubApi, 'repo' | 'user'> & {
            repo?: Maybe<ResolversTypes['GithubRepo']>;
            user?: Maybe<ResolversTypes['GithubUser']>;
        }
    >;
    GithubBranch: ResolverTypeWrapper<
        Omit<GithubBranch, 'lastCommit'> & { lastCommit?: Maybe<ResolversTypes['GithubCommit']> }
    >;
    ...
    GithubRepo: ResolverTypeWrapper<
        Omit<GithubRepo, 'branches' | 'commits' | 'owner'> & {
            branches?: Maybe<Array<Maybe<ResolversTypes['GithubBranch']>>>;
            commits?: Maybe<Array<Maybe<ResolversTypes['GithubCommit']>>>;
            owner?: Maybe<ResolversTypes['GithubUser']>;
        }
    >;
    GithubStatus: ResolverTypeWrapper<GithubStatus>;
    GithubUser: ResolverTypeWrapper<
        Omit<GithubUser, 'repos'> & { repos?: Maybe<Array<Maybe<ResolversTypes['GithubRepo']>>> }
    >;
...
export type ResolversParentTypes = {
    ...
    GithubAPI: Omit<GithubApi, 'repo' | 'user'> & {
        repo?: Maybe<ResolversParentTypes['GithubRepo']>;
        user?: Maybe<ResolversParentTypes['GithubUser']>;
    };
    ...
    GithubRepo: Omit<GithubRepo, 'branches' | 'commits' | 'owner'> & {
        branches?: Maybe<Array<Maybe<ResolversParentTypes['GithubBranch']>>>;
        commits?: Maybe<Array<Maybe<ResolversParentTypes['GithubCommit']>>>;
        owner?: Maybe<ResolversParentTypes['GithubUser']>;
    };
...
export type GithubGitTipResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['GithubGitTip'] = ResolversParentTypes['GithubGitTip'],
> = {
