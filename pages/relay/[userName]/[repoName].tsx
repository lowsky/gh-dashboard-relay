...
export const RelayRootMain = () => {
    ...
    return <ShowUserRepoContent userData={userData} repoData={repoData} />;
};

function ShowUserRepoContent({ userData, repoData }) {
    return (
        <UILibContext.Provider value={UILibWithRelaySupport}>
            <UserRepo user={userData.user} repo={repoData.repo} />
