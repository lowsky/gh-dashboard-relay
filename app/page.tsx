        ...
        <div>
            <VStack spacing="2" align="left">
                ...
                <ul>
                    ...
                    <li>
                        <InternalLink href={'/restful'}>Old way</InternalLink> <strong>All or nothing:</strong> Fetching
                        all data in a top-level `useEffect()` + props-drilling
                    </li>
                    <li>
                    ...
                    <li>
                        <InternalLink href={'/side-by-side'}>Side-by-Side</InternalLink> <strong>Comparison:</strong>{' '}
                        Show incrementally loading and wait-for-all
                    </li>
                </ul>
            </VStack>
        </div>
